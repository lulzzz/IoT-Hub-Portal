...
namespace AzureIoTHub.Portal.Server.Tests.Controllers.V10
{
    ...
    public class DeviceModelsControllerTests
    {
        ...
        private Mock<IDeviceModelMapper<DeviceModel>> mockDeviceModelMapper;
        ...
        public void SetUp()
        {
            ...
            this.mockDeviceModelMapper = this.mockRepository.Create<IDeviceModelMapper<DeviceModel>>();
        ...
        public void GetList_Should_Return_A_List()
        {
            ...
            // Act
            var result = deviceModelsController.Get();
            ...
            var okArray = okObjectResult.Value as IEnumerable<DeviceModel>;

            Assert.IsNotNull(okArray);
            Assert.AreEqual(10, okArray.Count());
        ...
        public void When_Model_NotExists_GetItem_Should_Return_404()
        {
            ...
            // Act
            var result = deviceModelsController.Get(Guid.NewGuid().ToString());
        ...
        public void GetAvatar_Should_Return_The_Computed_Model_Avatar_Uri()
        {
            ...
            // Act
            var result = deviceModelsController.GetAvatar(entity.RowKey);
            ...
            Assert.IsNotNull(okObjectResult.Value);
            Assert.AreEqual(expectedUrl, okObjectResult.Value.ToString());
        ...
        public void When_Model_NotExists_GetAvatar_Should_Return_404()
        {
            ...
            // Act
            var result = deviceModelsController.GetAvatar(Guid.NewGuid().ToString());
        ...
        public async Task ChangeAvatar_Should_Change_Model_Image_Stream()
        {
            ...
            // Act
            var result = await deviceModelsController.ChangeAvatar(entity.RowKey, mockFile.Object);
        ...
        public async Task When_Model_NotExists_ChangeAvatar_Should_Return_404()
        {
            ...
            // Act
            var result = await deviceModelsController.ChangeAvatar(Guid.NewGuid().ToString(), mockFile.Object);
