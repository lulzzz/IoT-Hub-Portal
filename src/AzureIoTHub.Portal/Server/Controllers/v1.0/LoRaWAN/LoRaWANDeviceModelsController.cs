...
namespace AzureIoTHub.Portal.Server.Controllers.V10.LoRaWAN
{
    ...
    public class LoRaWANDeviceModelsController : DeviceModelsControllerBase<LoRaDeviceModel>
    {
        /// <summary>
        ...
        public LoRaWANDeviceModelsController(
            ILogger<LoRaWANDeviceModelsController> log,
            IDeviceModelImageManager deviceModelImageManager,
            IDeviceModelCommandMapper deviceModelCommandMapper,
            IDeviceModelMapper<LoRaDeviceModel> deviceModelMapper,
